 ...
 * value automatically.
 *
 * @page language/functions
 * @section default-parameters
 * @syntax function greet(name: string = "world"): void
 * @compilesTo The function signature includes all parameters. Defaults
 ...
 * }
 * @limitation Default values must be literals or simple expressions.
 * @since 0.2.0
 */
