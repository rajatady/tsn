...
export const geometryCases: GeometryCase[] = [
  ...
  {
    id: 'view-border',
    label: 'Neutral view with border and padding',
    category: 'layout',
    viewport: { width: 560, height: 220 },
    testIds: ['root', 'panel', 'title', 'body'],
    features: ['View', 'border', 'border-color', 'p-', 'rounded-xl'],
    tolerance: { position: 2, size: 2 },
  },
  {
    id: 'absolute-position',
    label: 'Absolute positioning with inset utilities',
    category: 'layout',
    viewport: { width: 560, height: 260 },
    testIds: ['root', 'hero', 'badge', 'badge-text', 'cta'],
    features: ['View', 'relative', 'absolute', 'top-*', 'left-*', 'bottom-*', 'right-*'],
    tolerance: { position: 2, size: 4 },
  },
  {
    id: 'textarea-deep',
    label: 'Multiline text area sizing and alignment',
    category: 'layout',
    viewport: { width: 560, height: 360 },
    testIds: ['root', 'textarea-main', 'row-secondary', 'textarea-side', 'action'],
    features: ['TextArea', 'w-[]', 'h-[]', 'items-end'],
    tolerance: { position: 4, size: 6 },
  },
  {
    id: 'choice-controls',
    label: 'Select and composed choice controls',
    category: 'layout',
    viewport: { width: 600, height: 360 },
    testIds: ['root', 'select-field', 'select', 'checkbox-field', 'radio-group', 'radio-primary', 'radio-secondary'],
    features: ['Select', 'Checkbox', 'Radio', 'View composition'],
    tolerance: { position: 4, size: 6 },
  },
  ...
  {
    id: 'flex-basis',
    label: 'Flex-1 equal distribution with varying content',
    category: 'layout',
    viewport: { width: 700, height: 96 },
    testIds: ['root', 'col1', 'col2', 'col3'],
    features: ['flex-1', 'flex-basis:0', 'gap'],
    tolerance: { position: 4, size: 8 },
  },
  {
    id: 'justify-end',
    label: 'Content anchored to bottom with justify-end',
    category: 'layout',
    viewport: { width: 500, height: 300 },
    testIds: ['root', 'title', 'subtitle'],
    features: ['VStack', 'justify-end', 'p-8', 'gap-1'],
  },
  {
    id: 'items-end',
    label: 'Bottom-aligned children with items-end',
    category: 'layout',
    viewport: { width: 500, height: 200 },
    testIds: ['root', 'tall', 'short', 'medium'],
    features: ['HStack', 'items-end', 'gap-6'],
    tolerance: { position: 2, size: 2 },
  },
  {
    id: 'empty-spacer',
    label: 'Empty VStacks as fixed vertical gaps',
    category: 'layout',
    viewport: { width: 400, height: 300 },
    testIds: ['root', 'block-a', 'gap-8', 'block-b', 'gap-20', 'block-c', 'gap-2', 'block-d'],
    features: ['VStack', 'h-[]', 'gap-0'],
    tolerance: { position: 2, size: 2 },
  },
  {
    id: 'zstack-overlay',
    label: 'ZStack with layered children and justify-end text',
    category: 'composite',
    viewport: { width: 500, height: 250 },
    testIds: ['root', 'hero', 'bg-layer', 'text-layer', 'title', 'subtitle'],
    features: ['ZStack', 'justify-end', 'overflow-hidden', 'rounded-2xl'],
    tolerance: { position: 8, size: 8 },
  },
  {
    id: 'horizontal-scroll',
    label: 'Horizontal scroll carousel with fixed-width children',
    category: 'composite',
    viewport: { width: 500, height: 200 },
    testIds: ['root', 'row', 'item-a', 'item-b', 'item-c', 'item-d'],
    features: ['Scroll', 'overflow-x-auto', 'gap-4', 'w-[]'],
    tolerance: { position: 4, size: 8 },
  },
  {
    id: 'multi-col-grid',
    label: 'Three equal flex-1 columns with rows and dividers',
    category: 'composite',
    viewport: { width: 600, height: 200 },
    testIds: ['root', 'col-a', 'col-b', 'col-c', 'a1', 'a2', 'a3', 'b1', 'c1'],
    features: ['HStack', 'VStack', 'flex-1', 'gap-0', 'Divider'],
    tolerance: { position: 4, size: 8 },
  },
  {
    id: 'metric-strip',
    label: 'Centered stats in flex-equal columns with dividers',
    category: 'composite',
    viewport: { width: 600, height: 120 },
    testIds: ['root', 'm1', 'm2', 'm3', 'm1-val', 'm2-val', 'm3-val'],
    features: ['HStack', 'VStack', 'flex-1', 'items-center', 'Divider'],
    tolerance: { position: 8, size: 8 },
  },
  {
    id: 'editorial-card',
    label: 'Fixed-width card with image placeholder and text hierarchy',
    category: 'composite',
    viewport: { width: 740, height: 400 },
    testIds: ['root', 'card-a', 'img-a', 'eyebrow-a', 'title-a', 'sub-a', 'card-b', 'img-b'],
    features: ['VStack', 'w-[]', 'gap-0', 'h-[]', 'uppercase', 'tracking-wide'],
    tolerance: { position: 4, size: 8 },
  },
  {
    id: 'card-no-padding',
    label: 'Card without padding class and thin height cards',
    category: 'card',
    viewport: { width: 400, height: 250 },
    testIds: ['root', 'card-bare', 'text-bare', 'card-padded', 'text-padded', 'card-thin', 'card-medium'],
    features: ['Card', 'rounded-xl', 'h-[]', 'p-4'],
    tolerance: { position: 4, size: 4 },
  },
