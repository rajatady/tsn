...
2. **Compile the maintained UI apps after host/compiler changes**: `./strictts build examples/native-gui/dashboard.tsx`, `./strictts build examples/native-gui/incident-tracker.tsx`, and `./strictts build examples/native-gui/app-store.tsx`
